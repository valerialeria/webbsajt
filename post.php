...
<div class="container">
<h1 class="welcome">Vad har du på tankarna <?php echo htmlspecialchars($user["username"]); ?> ? </h1>
...
<div class="post">
    ...
    while($c = $comments->fetch_assoc()): ?>
        <div class="comment">
            <strong><?php echo htmlspecialchars($c["username"]); ?>:</strong> <?php echo nl2br(htmlspecialchars($c["comment"])); ?>
        </div>
    <?php endwhile; ?>
